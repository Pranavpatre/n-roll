...
-- Enable pg_net for HTTP calls from cron (already enabled on Supabase by default)
CREATE EXTENSION IF NOT EXISTS pg_net;

-- Schedule send-weekly-digest every Monday at 8:00 AM UTC
-- Before running this migration, set the service role key as a database setting:
